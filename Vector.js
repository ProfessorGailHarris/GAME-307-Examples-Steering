...
// Date downloaded: 2020-06-07
// All comments below are my own
...
//However, for mathematical correctness some of these should not be allowed,
//or should produce an error.
...
Vector.prototype = {
  ...
  add: function(v) {
    ...
    // return error if argument not a vector?
  },
  subtract: function(v) {
    if (v instanceof Vector) return new Vector(this.x - v.x, this.y - v.y, this.z - v.z);
    else return new Vector(this.x - v, this.y - v, this.z - v);
